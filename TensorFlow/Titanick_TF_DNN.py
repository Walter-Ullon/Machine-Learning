# Random Forests algorithm applied to the Titanic Dataset from Kaggle.
...
clf = tf.contrib.learn.DNNClassifier(feature_columns = feature_columns, hidden_units=[512, 512, 512],
                                            n_classes=2)
clf.fit(X_train, y_train, steps=2000)
# Predict:
