...
network.add(layers.Dense(16, kernel_regularizer=regularizers.l1(0.001), activation='relu',input_shape=(10000,)))
network.add(layers.Dense(16, kernel_regularizer=regularizers.l1(0.001), activation='relu'))
