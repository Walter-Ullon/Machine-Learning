...
network.add(layers.Dense(64, kernel_regularizer=regularizers.l1(0.0001), activation='relu', input_shape=(10000,)))
#network.add(layers.Dense(64, kernel_regularizer=regularizers.l1(0.0001), activation='relu'))
